...
public class SpellBuilder {
    ...
    public SpellBuilder animations(AnimationHolder castStart, AnimationHolder castFinish) {
        ...
        this.spell.recast_animation = new SpellAnimationData(castStart);
        this.spell.recast_finish_animation = new SpellAnimationData(castFinish);
        return this;
    }
    ...
    public SpellBuilder singleAnimation(AnimationHolder castStart) {
        ...
        this.spell.recast_animation = new SpellAnimationData(castStart);
        this.spell.recast_finish_animation = new SpellAnimationData(AnimationHolder.none());
        return this;
    }
